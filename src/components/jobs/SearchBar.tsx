...
export default function SearchBar({ initialQuery = '', initialLocation = '' }: Props) {
  ...
  return (
    <form
      ...
      className="flex flex-col sm:flex-row gap-0 bg-white rounded-2xl
                 shadow-[0_4px_24px_rgba(0,0,0,0.12)] overflow-hidden
    ...
    >
      ...
      <div className="block sm:hidden h-px bg-slate-100 mx-4" />
      ...
      <div className="p-2">
        <button
          ...
          className="w-full sm:w-auto bg-[#0f2d1f] text-white text-sm font-semibold
                     px-6 py-2.5 rounded-xl hover:bg-[#166534]
