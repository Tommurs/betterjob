...
export default function MessageHiringManagerButton({ jobId, employerId, applicantId }: Props) {
  ...
  async function handleClick() {
    ...
    // TODO: enforce 85% match score gate here
    // if (matchScore < 85) { setLoading(false); return }
  ...
  return (
    ...
    >
      {loading ? '...' : 'Message Hiring Manager'}
    </button>
  )
}
